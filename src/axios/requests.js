...
let getScrapedResults = async(query, location) => {
    try {
        let response = await axios.post("https://hireandfindapi.herokuapp.com/api/sjobs", {
            query: query,
            location: location,
        });
...
let getScholarShips = async(country, dept) => {
    try {
        let response = await axios.post(
            "https://hireandfindapi.herokuapp.com/api/sjobs/scholarships", {
                country: country,
                dept: dept,
            }
        );
...
let registerUser = async(firstname, lastname, email, password, role) => {
    try {
        ...
        let response = await axios.post(
            "https://hireandfindapi.herokuapp.com/api/accounts/auth/register", {
                firstname: firstname,
                lastname: lastname,
                email: email,
                password: password,
...
let loginUser = async(email, password) => {
    try {
        ...
        let response = await axios.post(
            "https://hireandfindapi.herokuapp.com/api/accounts/auth/login", {
                email: email,
                password: password,
            }
        );
...
let getUser = async(id) => {
    try {
        let response = await axios.get(
            `https://hireandfindapi.herokuapp.com/api/users/getone/${id}`, {
                headers: {
...
let updateUserAsRole = async(id, body) => {
    try {
        ...
        let response = await axios.put(
            `https://hireandfindapi.herokuapp.com/api/users/update/${id}`,
            body, {
                headers: {
                    "auth-token": ls.get("token"),
                },
...
let updateUser = async(id, body) => {
    try {
        ...
        console.log("body", body);
        let response = await axios.put(
            `https://hireandfindapi.herokuapp.com/api/users/updateInUser/${id}`,
            body, {
                headers: {
                    "auth-token": ls.get("token"),
                },
...
let postJob = async(
    ...
    try {
        let response = await axios.post(
            "https://hireandfindapi.herokuapp.com/api/rjobs/postJob", {
                company: company,
                title: title,
                category: category,
...
let updateJob = async(
    ...
    try {
        let response = await axios.put(
            `https://hireandfindapi.herokuapp.com/api/rjobs/${jobId}`, {
                company: company,
                title: title,
                category: category,
                selectedLocation: selectedLocation,
...
let getJobs = async() => {
    try {
        ...
        let response = await axios.get("https://hireandfindapi.herokuapp.com/api/rjobs");
...
let createCV = async(
    ...
    try {
        let response = await axios.post(
            "https://hireandfindapi.herokuapp.com/api/cv/createCV", {
...
let getCV = async(id) => {
    try {
        let response = await axios.get(`https://hireandfindapi.herokuapp.com/api/cv/getCV/${id}`, {
            headers: {
                "auth-token": ls.get("token"),
            },
        });
...
let updateCv = async(
    ...
    try {
        let response = await axios.put(
            `https://hireandfindapi.herokuapp.com/api/cv/updateCV/${id}`, {
                experience: experience,
                firstName: firstName,
                lastName: lastName,
                profession: profession,
...
let getJobsPostedByRecuriters = async(id) => {
    ...
    try {
        let response = await axios.get(
            `https://hireandfindapi.herokuapp.com/api/rjobs/findByRecruiter/${id}`, {
                headers: {
                    "auth-token": ls.get("token"),
                },
            }
...
let getJobsAppliedBySeeker = async() => {
    ...
    try {
        let response = await axios.get(
            `https://hireandfindapi.herokuapp.com/api/rjobs/fetchApplied`, {
                headers: {
                    "auth-token": ls.get("token"),
                },
            }
...
let getRecommendedJobs = async() => {
    ...
    try {
        let response = await axios.get(
            `https://hireandfindapi.herokuapp.com/api/rjobs/recommendations`, {
                headers: {
                    "auth-token": ls.get("token"),
                },
            }
...
let getJobDetails = async(id) => {
    ...
    try {
        let response = await axios.get(`https://hireandfindapi.herokuapp.com/api/rjobs/${id}`, {
            headers: {
                "auth-token": ls.get("token"),
            },
        });
...
let getAll = async() => {
    console.log("getAll");
    try {
        let response = await axios.get(`https://hireandfindapi.herokuapp.com/api/search`);
...
let deleteUser = async(id) => {
    ...
    try {
        let response = await axios.delete(`https://hireandfindapi.herokuapp.com/api/users/${id}`, {
            headers: {
                "auth-token": ls.get("token"),
            },
        });
...
let deleteJob = async(id) => {
    ...
    try {
        let response = await axios.delete(`https://hireandfindapi.herokuapp.com/api/rjobs/${id}`, {
            headers: {
                "auth-token": ls.get("token"),
            },
        });
...
let getApplicants = async(jobId) => {
    ...
    try {
        let response = await axios.get(
            `https://hireandfindapi.herokuapp.com/api/rjobs/getApplications/${jobId}`, {
                headers: {
                    "auth-token": ls.get("token"),
                },
            }
...
let updateApplicantionStatus = async(appId, status) => {
    ...
    try {
        let response = await axios.put(
            `https://hireandfindapi.herokuapp.com/api/rjobs/UpdateStatus/${appId}`, {
                status: status,
                headers: {
                    "auth-token": ls.get("token"),
                },
...
let applyToJob = async(jobId) => {
    ...
    try {
        let response = await axios.get(
            `https://hireandfindapi.herokuapp.com/api/rjobs/application/${jobId}`, {
                headers: {
                    "auth-token": ls.get("token"),
                },
            }
...
let stripApi = async(price, plan, jobData, token) => {
    ...
    try {
        let response = await axios.post(
            `https://hireandfindapi.herokuapp.com/api/rjobs/stripe`, {
                price,
                plan,
                jobData,
                token,
...
let quiz = async(question, jobId) => {
    ...
    try {
        let response = await axios.post(
            `https://hireandfindapi.herokuapp.com/api/rjobs/quiz`, {
                question,
                jobId,
            }, {
                headers: {
...
let test = async(jobId) => {
    ...
    try {
        let response = await axios.get(
            `https://hireandfindapi.herokuapp.com/api/rjobs/test/${jobId}`, {
                headers: {
                    "auth-token": ls.get("token"),
                },
            }
...
let answer = async(jobId, answer) => {
    ...
    try {
        let response = await axios.post(
            `https://hireandfindapi.herokuapp.com/api/rjobs/answer/${jobId}`, { answer }, {
                headers: {
                    "auth-token": ls.get("token"),
                },
            }
...
let getTrendingJobs = async() => {
    ...
    try {
        let response = await axios.get(
            `https://hireandfindapi.herokuapp.com/api/rjobs/getTrendingJobs`
        );
...
let flagJob = async(jobId) => {
    ...
    try {
        let response = await axios.get(
            `https://hireandfindapi.herokuapp.com/api/rjobs/flagjob/${jobId}`, {
                headers: {
                    "auth-token": ls.get("token"),
                },
            }
...
let unFlagJob = async(jobId) => {
    ...
    try {
        let response = await axios.get(
            `https://hireandfindapi.herokuapp.com/api/rjobs/unflagjob/${jobId}`, {
                headers: {
                    "auth-token": ls.get("token"),
                },
            }
...
let addMessage = async(name, email, subject, message) => {
    ...
    try {
        let response = await axios.post(
            `https://hireandfindapi.herokuapp.com/api/users/addmessage`, { name: name, email: email, subject: subject, message: message }, {
                headers: {
                    "auth-token": ls.get("token"),
                },
            }
...
let getMessage = async() => {
    ...
    try {
        let response = await axios.get(
            `https://hireandfindapi.herokuapp.com/api/users/getmessage`, {
                headers: {
                    "auth-token": ls.get("token"),
                },
            }
