                                    ...
                                    <div class="contact-right-area wow fadeIn">
                                        ...
                                        <div class="contact-info">
                                            <div class="single-contact">
                                                ...
                                                <p>Main Office: Opening Soon  <br/> Opening Soon after completing this project</p>
                                            </div>
                                            <div class="single-contact">
                                                <div class="contact-icon">
                                                ...
                                                <p><Link
                                                        ...
                                                        Support: <span class="__cf_email__"
                                                            data-cfemail="5f363139301f323e3633713c3032">[email&#160;protected]</span>
                                                        Technical Support: </Link></p>
                                                <p><Link
                                                        to="/"><span
                                                            class="__cf_email__"
                                                            data-cfemail="097a7c7979667b7d4964686065276a6664">[email&#160;protected]</span></Link>
                                                </p>
                                            </div>
                                            <div class="single-contact">
                                                <div class="contact-icon">
                                                ...
                                                <p><Link to="#">Main Office: ###</Link></p>
                                                <p><Link to="#">Customer Supprort: ###</Link></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
