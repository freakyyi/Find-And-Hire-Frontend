    ...
    return (
      <>
        ...
        >
                      ...
                      return (
                        ...
                        >
                          <div class="timeline-head px-4 pt-3">
                            <div class="h5">{data.jobTitle} - {data.employer}</div>
                          </div>
                          <div class="timeline-body px-4 pb-4">
                            <div class="text-muted text-small mb-3">
                              {data.startDateW} - {data.endDateW} | {data.stateW}
                            </div>
          ...
          <Pdf targetRef={ref} filename={this.props.firstname + " CV.pdf"} x={.05} y={.05}>
            {({ toPdf }) => (
              <button onClick={toPdf} class="button btn btn-common"  style={{ align : "center" }}>
                Generate a PDF{" "}
              </button>
            )}
          </Pdf>
